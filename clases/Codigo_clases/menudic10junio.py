...
def msgError(msg):
    """
    The function "msgError" prints an error message and waits for the user to press enter to continue.
    
    :param msg: The parameter "msg" is a string that represents the error message that will be displayed
    """
    print("----> ¡ERROR!" + msg)
